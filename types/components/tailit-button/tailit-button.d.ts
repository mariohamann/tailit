...
declare const TailitButton_base: (new (...args: any[]) => import("../tailit-element/tailit-element").TailitElementInterface) & (new (...args: any[]) => import("../headless/renderless-button/renderless-button").RenderlessButtonInterface) & typeof LitElement;
